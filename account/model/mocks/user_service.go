...
func (m *MockUserService) FindById(ctx context.Context, uuid uuid.UUID) (*model.User, error) {
	//TODO implement me
	panic("implement me")
}

func (m *MockUserService) Create(ctx context.Context, u *model.User) error {
	//TODO implement me
	panic("implement me")
}
